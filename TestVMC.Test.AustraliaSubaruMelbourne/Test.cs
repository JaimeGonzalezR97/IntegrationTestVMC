...
namespace TestVMC.Test.AustraliaSubaru
{
    public class Test
    {
        ...
        {
            //Arrange
            int registryNumberId = (int)AUSSUBAMEL.RegistryNumber;
            int stateId = (int)AUSSUBAMEL.State;
            int redbookCodeId = (int)AUSSUBAMEL.RedBookCode;
            ...
            {
                CountryBrandId = (int)CountryBrandId.AUSSUBAMEL,
                FormId = formId,
